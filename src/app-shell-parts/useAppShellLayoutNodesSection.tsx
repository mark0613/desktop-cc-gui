...
export function useAppShellLayoutNodesSection(ctx: any) {
  const {
    ...
    applySelectedCollaborationMode, approvals, assignWorkspaceGroup, attachImages, baseWorkspaceRef, branches, canInterrupt, cancelClonePrompt,
    ...
    handleReviewPromptKeyDown, handleSearchPaletteMoveSelection, handleSelectAgent, handleSelectCommit, handleSelectDiff, handleSelectDiffForPanel, handleSelectModel, handleSelectOpenAppId,
    ...
    handleSendPromptToNewAgent, handleSetAccessMode, handleSetGitRoot, handleStageGitAll, handleStageGitFile, handleStartGuidedConversation, handleStartWorkspaceConversation, handleSwitchAccount,
