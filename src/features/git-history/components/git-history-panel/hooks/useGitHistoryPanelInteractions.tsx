// @ts-nocheck
import { useCallback, useEffect, useMemo, type CSSProperties, type KeyboardEvent, type MouseEvent } from "react";
import type { GitCommitDiff, GitPrWorkflowDefaults } from "../../../../../types";
...
type BranchCompareDirection = "ahead" | "behind";
type GitHistoryCommit = { sha: string; [key: string]: unknown };
