const zhPart1 = {
  ...
  settings: {
    ...
    runtimePoolDescription: "查看受管 Codex runtime、调整池预算，并手动关闭或固定当前 runtime。",
    ...
    runtimeMaxHot: "Codex Hot 上限",
    runtimeMaxWarm: "Codex Warm 上限",
    runtimeWarmTtl: "Warm TTL（秒）",
    runtimePoolSummary: "运行时池摘要",
    runtimeSummaryLine:
      "总数 {{total}} · Hot {{hot}} · Warm {{warm}} · Busy {{busy}} · Pinned {{pinned}}",
    runtimeDiagnosticsLine:
      "Orphan 已清理 {{cleaned}} · Orphan 失败 {{failed}} · 强制 kill {{forced}}",
